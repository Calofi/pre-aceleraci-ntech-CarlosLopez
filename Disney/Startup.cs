...
namespace Disney
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<DisneyContexto>(optionsAction: (provider, builder) =>
            {
                builder.UseInternalServiceProvider(provider);
                builder.UseSqlServer(connectionString: "data source=DESKTOP-DH6KG6T\\SQLEXPRESS01;Database=DisneyDb;integrated security=True;");
